...
*Figure 1: Context-seeking rate convergence showing mean ± standard deviation across 5 seeds.*

**Source**: Generated by [3-multi_seed_analysis.ipynb](../3-multi_seed_analysis.ipynb)
